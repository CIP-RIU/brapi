...
#' @family brapicore
#' @export
ba_observationvariables_search <- function(con = NULL, observationVariableDbIds = "any", ontologyXrefs = "any", ontologyDbIds = "any", methodDbIds = "any", 
    scaleDbIds = "any", names = "any", datatypes = "any", traitClasses = "any", rclass = "tibble") {
    ...
    try({
        body <- list(observationVariableDbIds = observationVariableDbIds %>% as.list(), ontologyXrefs = ontologyXrefs, ontologyXrefs = ontologyXrefs, 
            ontologyXrefs = ontologyXrefs, scaleDbIds = scaleDbIds, names = names, datatypes = datatypes, traitClasses = traitClasses)
