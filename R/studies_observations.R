...
#' @family phenotyping
#' @export
studies_observations <- function(con = NULL, studyDbId = 1, observationVariableDbId = 1:3, page = 0, pageSize = 1000, 
    rclass = "tibble") {
    ...
    try({
        ...
        # if (rclass %in% c('tibble', 'data.frame')) { out = sgp2tbl(res, rclass) }
