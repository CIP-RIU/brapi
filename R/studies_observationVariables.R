...
#' @references \url{https://github.com/plantbreeding/API/blob/master/Specification/Studies/StudyObservationVariables.md}
...
#' @family phenotyping
#' @export
studies_observationvariables <- function(con = NULL, studyDbId = 1,
                                 rclass = "tibble") {
