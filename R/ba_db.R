...
ba_db <- function() {
  ...
  musabase <- as.ba_db(crop = "musa",
                      ...
                      multicrop = FALSE,
                      bms = FALSE)
  cassavabase <- as.ba_db(crop = "cassava",
                             secure = TRUE,
                             protocol = "https://",
                             db = "cassavabase.org",
                             port = 80,
                             multicrop = FALSE,
                             bms = FALSE)
  germinate <- as.ba_db(crop = "cactuar",
                           secure = TRUE,
                           protocol = "https://",
                           db = "ics.hutton.ac.uk",
                           port = 80,
  ...
  bms_test <- as.ba_db(crop = "wheat",
                          ...
                          multicrop = TRUE,
                          bms = TRUE)
  mockbase <- as.ba_db(crop = "sweetpotato",
                          secure = FALSE,
                          protocol = "http://",
                          db = "127.0.0.1",
                          port = 2021,
  ...
  snpseek <- as.ba_db(crop = "rice",
                         ...
                         token = "",
                         bms = TRUE)
  eu_sol <- as.ba_db(crop = "tomato",
                        secure = TRUE,
                        db = "www.eu-sol.wur.nl",
                        apipath = "webapi",
                        multicrop = TRUE,
                        bms = FALSE)
  mgis <- as.ba_db(crop = "musa",
                      secure = TRUE,
                      protocol = "https://",
