...
#' @family phenotyping
#' @export
ba_studies_search <- function(con = NULL, studyType = "any", programDbId = "any", locationDbId = "any", seasonDbId = "any", germplasmDbIds = "any", 
    observationVariableDbIds = "any", active = "any", sortBy = "any", sortOrder = "any", page = 0, pageSize = 1000, rclass = "tibble") {
    ...
    if (nurl <= 2000) {
        ...
        body <- list(studyType = studyType, programDbId = programDbId, locationDbId = locationDbId, seasonDbId = seasonDbId, active = active, sortBy = sortBy, 
