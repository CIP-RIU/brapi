...
ba_studies_search <- function(con = NULL, studyType = "any", programDbId = "any", locationDbId = "any",
  ...
  pobservationVariableDbIds <- paste0("observationVariableDbIds=", observationVariableDbIds, "&") %>%
    paste(collapse = "")
  ...
  pstudies_search <- paste0(pstudies_search, pstudyType, pprogramDbId, plocationDbId, pseasonDbId,
                            pgermplasmDbIds, pobservationVariableDbIds,
