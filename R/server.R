#
# server <- function(port = 2021, daemonized = FALSE){
# library(jug)
# library(magrittr)
...
# x = system.file("apps/brapi/utils", package = "brapi") %>% list.files(full.names = TRUE) %>%
#     lapply(source)
...
#   serve_it(port = port, daemonized = daemonized)
# }
