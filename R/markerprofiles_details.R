...
#' @family genotyping
#' @export
markerprofiles_details <- function(con = NULL, markerprofilesDbId = "", expandHomozygotes = FALSE, unknownString = "N", 
    sepPhased = "|", sepUnphased = "/", page = 0, pageSize = 10000, rclass = "tibble") {
    brapi::check(con, FALSE, "markerprofiles/id/")
    brp <- get_brapi(con)
